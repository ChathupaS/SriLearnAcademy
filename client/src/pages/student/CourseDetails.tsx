    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">SriLearn Academy</span>
          </p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-100 ${openSection[index] ? "max-h-96" : "max-h-0"}`}
                  >
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calculateNumberOfLecures(courseData)} lessons</p>
              </div>
            </div>
