...
const StudentsEnrolled = () => {
  ...
  return enrolledStudents ? (
    <div className="min-h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white broder border-gray-300">
        <table className="md:table-auto table-fixed w-full overflow-hidden pb-4">
          <thead className="text-gray-900 border-b border-gray-300 text-sm text-left">
            <tr>
              <th className="px-3 py-3 font-semibold text-center hidden sm:table-cell">
                #
              </th>
              ...
              <tr key={index} className="border-b border-gray-300">
                ...
                <td className="px-4 py-3 hidden sm:table-cell">
                  {(item as any).purchaseDate
                    ? new Date((item as any).purchaseDate).toLocaleDateString()
                    : "-"}
                </td>
              </tr>
            ))}
